...
value and then call the other overloaded method passing the correct
minutes and seconds calculated so that it can calculate correctly.
 ...
 */
public class Main {
    private static String getRemainingMinutes(long minutes){
        if(minutes<0){
    ...
    private static String getDurationString(long minutes,long seconds){
     ...
     //   long remainingMinutes=minutes%60;
        return hours+" h "+getRemainingMinutes(minutes)+seconds+" s ";
    }
...
//    }
    ...
    public static void main(String[] args) {
        System.out.println(getRemainingMinutes(3659));
        System.out.println( getDurationString(3659,1));
